<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Devolucion.aspx.cs" Inherits="Web.Devolucion" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Titulo" runat="server" Text="Ingresar Nueva Devolucion"></asp:Label>
            ...
            <asp:Label ID="lblProveedor" runat="server" Text="Id Proveedor: "></asp:Label>
            ...
            <br />
            <br />
            <asp:GridView ID="grdDevolucionDetalle" runat="server" AutoGenerateColumns="false" OnRowDeleting="grdDevolucionDetalle_RowDeleting" ShowFooter="true">
                <Columns>
